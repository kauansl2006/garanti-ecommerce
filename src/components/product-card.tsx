    ...
    return (
        <div className="w-full h-full flex flex-col items-center justify-center gap-y-[8px] rounded-[4px] bg-white border-[1px] border-neutral-300 p-[12px] relative">
            ...
            <div className="absolute top-[12px] left-[12px] flex flex-col items-start justify-start gap-y-[8px] z-10">
                {product.discount && (
                    <Badge variant="default" className="px-[10px] py-[5px] rounded-[4px] text-b-xs leading-b-xs font-semibold bg-yellow-300 text-neutral-900">
                        {product.discount}% OFF
                    </Badge>
                )}
                {product.isHot && (
                    <Badge variant="default" className="px-[10px] py-[5px] rounded-[4px] text-b-xs leading-b-xs font-semibold bg-danger text-white">
                        HOT
                    </Badge>
                )}
                {!product.isAvailable && (
                    <Badge variant="default" className="px-[10px] py-[5px] rounded-[4px] text-b-xs leading-b-xs font-semibold bg-neutral-400" >
                        ESGOTADO
                    </Badge>
                )}
            </div>
            ...
            <div className="w-[100%] h-[100%] relative group">
                ...
                {size === "md" && (
                    <div className="absolute top-0 w-full h-full bg-[#00000033] hidden group-hover:flex items-center justify-center gap-x-[8px]">
                        <Button variant="ghost" size="icon" className="cursor-pointer w-[48px] h-[48px] rounded-full bg-white hover:bg-secondary hover:text-white p-[12px]">
            ...
            <div className="w-full flex flex-col items-start justify-start gap-y-[8px]">
                ...
                <Link href="#" className="hover:underline text-b-sm leading-b-sm font-normal">
                    {product.title}
                </Link>
                ...
                {size === "lg" && (
                    <>
                        ...
                        <div className="w-full flex items-center justify-between gap-x-[8px]">
                            <Button variant="ghost" size="icon" className="cursor-pointer w-[48px] h-[48px] rounded-[4px] hover:bg-neutral-300 p-[12px]">
                                <HeartIcon className="size-[28px] stroke-[1.5]" />
                            </Button>
                            <Button variant="secondary" size="default" className="cursor-pointer h-[48px] rounded-[4px] flex item-center justify-center gap-x-[8px] p-[12px]">
...
function Rating({ score }: { score: number }) {
    if (score > 0 && score <= 10) {
        ...
        return (
            <div className="flex start items-start justify-start gap-x-[6px]">
                <div className="w-full flex items-start justify-start gap-x-[2px]">
                    <StarIcon className="size-[20px] stroke-[0px]" fill="#EBC80C" />
                    <StarIcon className="size-[20px] stroke-[0px]" fill="#EBC80C" />
                    <StarIcon className="size-[20px] stroke-[0px]" fill="#262626" />
                    <StarIcon className="size-[20px] stroke-[0px]" fill="#262626" />
                    <StarIcon className="size-[20px] stroke-[0px]" fill="#262626" />
                </div>
                <span className="text-b-sm leading-b-sm font-normal text-neutral-500">
