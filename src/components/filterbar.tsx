...
export default function FilterBar() {
    return (
        <div className="w-[312px] h-full flex flex-col items-start justify-start gap-y-[24px] bg-white border-[1px] border-neutral-300 p-[20px] rounded-[4px]">
        <div className="flex flex-col items-start justify-start gap-y-[16px]">
        ...
        <div className="flex flex-col items-start justify-start gap-y-[16px]">
            ...
            <div className="grid grid-cols-2 items-start justify-start gap-y-[12px]">
