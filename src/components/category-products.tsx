...
export default function CategoryProducts() {
    return (
        <section className="w-full grid grid-cols-[repeat(1,auto)] sm:grid-cols-[repeat(2,auto)] 2xl:grid-cols-[repeat(4,auto)] gap-y-[24px] items-start gap-x-[24px] px-[5.625%] xl:px-[15.625%] py-[42px] md:py-[72px]">
