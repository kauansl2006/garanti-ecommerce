        ...
        <section className="px-[5.625%] lg:px-[15.625%] pt-[102px] md:pt-[32px] pb-[72px] grid grid-cols-1 lg:grid-cols-2 gap-[56px]">
            <div className="flex flex-col gap-[24px]">
                <Card className="w-full shadow-none border-[1px] border-neutral-300 rounded-[4px]">
                    <CardContent className="flex items-center justify-center" >
                        <div className="size-[250px] sm:size-[450px] lg:w-[616px] lg:h-[464px] relative">
                            <Image 
                                src={product.photos[0].src ? product.photos[0].src : "/not-photo.png"}
                                alt={product.photos[0].alt ? product.photos[0].alt : "Produto sem foto"}
                                fill={true}
                            />
                        </div>
                    </CardContent>
                ...
                <Carousel className="w-full">
                                ...
                                <Card className="w-max shadow-none border-[1px] border-neutral-300 p-[0px] rounded-[4px]">
                                    <CardContent className="flex items-center justify-center p-[0px]">
                                        <div className="size-[96px] relative">
                                            <Image 
                                                src={photo.src ? photo.src : "/not-photo.png"}
                                                alt={photo.alt ? photo.alt : "Produto sem foto"}
                                                fill={true}
                                            />
                                        </div>
                                    </CardContent>
                    ...
                    <CarouselPrevious variant="default" className="hidden sm:inline-flex cursor-pointer hover:bg-primary -left-5" />
                    <CarouselNext variant="default" className="hidden sm:inline-flex cursor-pointer hover:bg-primary -right-5" />
                </Carousel>
            </div>
            ...
            <div className="flex flex-col gap-[24px]">
                <div className="flex flex-col gap-[16px]">
                    ...
                    <div className="grid grid-cols-2 gap-[8px]">
                        <p className="text-b-sm leading-b-sm lg:text-b-ty lg:leading-b-ty xl:text-b-sm xl:leading-b-sm font-normal">
                            Sku: <strong className="font-semibold">A264671</strong>
                        </p>
                        <p className="text-b-sm leading-b-sm lg:text-b-ty lg:leading-b-ty xl:text-b-sm xl:leading-b-sm font-normal">
                            Disponibilidade: <strong className="font-semibold text-success">Em Estoque</strong>
                        </p>
                        <p className="text-b-sm leading-b-sm lg:text-b-ty lg:leading-b-ty xl:text-b-sm xl:leading-b-sm font-normal">
                            Marca: <strong className="font-semibold">Apple</strong>
                        </p>
                        <p className="text-b-sm leading-b-sm lg:text-b-ty lg:leading-b-ty xl:text-b-sm xl:leading-b-sm font-normal">
                            Categoria: <strong className="font-semibold">Eletrônicos</strong>
                        </p>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-[16px]">
                    <div className="flex flex-col gap-[8px]">
                        ...
                        <RadioGroup id="color" className="flex flex-row gap-[10px]">
                        <RadioGroupItem 
                    ...
                    <div className="flex flex-col gap-[8px]">
                        ...
                        <Select>
                            ...
                            <SelectContent className="rounded-none">
                                <SelectItem value="item-1" className="h-[44px]">Item 1</SelectItem>
                                <SelectItem value="item-2" className="h-[44px]">Item 2</SelectItem>
                                <SelectItem value="item-3" className="h-[44px]">Item 3</SelectItem>
                            </SelectContent>
                        </Select>
                    </div>
                    ...
                    <div className="flex flex-col gap-[8px]">
                        ...
                        <Select>
                            <SelectTrigger className="w-full h-[44px] border-[1px] border-neutral-300 rounded-[4px]">
                                <SelectValue id="memory" placeholder="Memória" />
                            </SelectTrigger>
                            <SelectContent className="rounded-none">
                                <SelectItem value="item-1" className="h-[44px]">Item 1</SelectItem>
                                <SelectItem value="item-2" className="h-[44px]">Item 2</SelectItem>
                    ...
                    <div className="flex flex-col gap-[8px]">
                        ...
                        <Select>
                            <SelectTrigger className="w-full h-[44px] border-[1px] border-neutral-300 rounded-[4px]">
                                <SelectValue id="storage" placeholder="Memória" />
                            </SelectTrigger>
                            <SelectContent className="rounded-none">
                                <SelectItem value="item-1" className="h-[44px]">Item 1</SelectItem>
                                <SelectItem value="item-2" className="h-[44px]">Item 2</SelectItem>
                ...
                <div className="flex pt-[12px] gap-[16px]">
                    <div className="max-w-[164px] w-full h-[56px] flex items-center justify-between border-2 border-neutral-300 rounded-[4px]">
                        <Button variant="outline" className="rounded-none h-full">
                ...
                <div className="flex items-start 2xl:items-center justify-between">
                    <div className="flex flex-col 2xl:flex-row gap-x-[24px]">
                        <Button variant="link" className="cursor-pointer text-b-sm leading-b-sm font-normal text-neutral-700 hover:no-underline">
                    ...
                    <div className="flex items-center justify-center gap-[12px]">
                        ...
                        <Button variant="outline" size="icon" className="size-[16px] relative" >
                            <Image 
                                src="/facebook.svg"
