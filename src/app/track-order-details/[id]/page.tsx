...
const activities = [
    {
        icon: CheckCheckIcon,
        description: "Seu pedido foi entregue. Obrigado por comprar na Garanti!",
        date: "23 de junho de 2025 às 19h32"
    },
    {
        icon: UserRoundCheck,
        description: "Nosso entregador (John Wick) pegou seu pedido para entrega.",
        date: "23 de junho de 2025 às 19h32"
    },
    {
        icon: MapPinnedIcon,
...
export default async function Page({
    ...
    return (
        <main className="w-screen">
            ...
            <section className="px-[468px] py-[72px]">
                <div className="flex flex-col bg-white border-[1px] border-neutral-300 rounded-[4px]">
                    <div className="flex flex-col gap-[24px] p-[24px]">
                        <div className="flex items-center justify-between gap-[24px] p-[24px] bg-neutral-100 border-[1px] border-neutral-300 rounded-[4px]">
                            <div className="flex flex-col gap-[8px]">
                                <p className="text-b-xl leading-b-xl font-normal">
                                    #{ id }
                                </p>
                                <p className="text-b-sm leading-b-sm font-normal text-neutral-700">
                                    4 Produtos • pedido feito em 17 de junho de 2025 às 19h32
                                </p>
                            </div>
                        ...
                        <p className="text-b-sm leading-b-sm font-normal text-neutral-700">
                            Pedido com previsão de chegada para <strong className="font-medium text-foreground">
                            23 de janeiro de 2021
                            </strong>
                        </p>

                        <div className="flex flex-col items-center justify-center gap-[24px]">
                            <div className="w-[722px] flex items-center justify-center relative">
                                <Progress value={33.3} className="[&>*]:bg-primary bg-[#FDFAE7] border-[1px] border-neutral-300" />
                            ...
                            <div className="flex w-full">
                                {steps.slice(0,2).map((step, index) => (
                                    <div key={index} className="w-[234px] h-[64px] flex flex-col items-center justify-center gap-[12px]">
                                        <step.icon className="size-[32px] stroke-[1.5px] text-primary"/>
                                ...
                                {steps.slice(2,4).map((step, index) => (
                                    <div key={index} className="w-[234px] h-[64px] opacity-50 flex flex-col items-center justify-center gap-[12px]">
                                        <step.icon className="size-[32px] stroke-[1.5px] text-primary"/>
