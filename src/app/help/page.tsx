    ...
    <div className="h-[480px] bg-white border-[1px] border-neutral-300 rounded-[4px] flex flex-col gap-[24px] p-[32px]">
        <div className="flex flex-col gap-[12px]">
            ...
            <p className="text-b-sm leading-b-sm text-normal text-neutral-700">
              Interdum et malesuada famas ac ante ipsum primis in faucibus. Sed molestie accumsan dui, non iaculis primis in faucibu raesent eget sem purus.
            </p>
        </div>
        <div className="flex flex-col gap-[12px]">
            <Input 
            ...
            <Input 
                ...
                placeholder="Assunto" 
            />
            <Textarea className="resize-none rounded-[4px] h-[68px]" placeholder="Mensagem..." />
        </div>
        <Button 
            variant="default" 
            size="default"
