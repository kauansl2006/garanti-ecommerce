                        ...
                        {informations.map((information) => (
                            ...
                            >
                                ...
                                {products.map((product, index) => (
                                    <td
                                        key={index}
                                        className="max-w-[290px] w-full border-x-[1px] border-neutral-300 border-collapse px-[22px] py-[12px]"
                                    >
                                        {information.key === "cardProduto" && (
                                            <div className="flex flex-col items-center justify-center gap-[16px]">
                                                ...
                                                <div className="w-full flex gap-[12px]">
                                                    <Button className="cursor-pointer flex gap-[8px] w-[140px] h-[44px] text-white text-[14px]/[48px] font-bold rounded-[4px]">
                                                        ADQUIRIR
